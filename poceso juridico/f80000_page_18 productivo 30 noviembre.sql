...
--   Date and Time:   16:27 Tuesday November 30, 2021
...
,p_last_upd_yyyymmddhh24miss=>'20211026132306'
);
...
,p_attribute_01=>'apex.submit({request: "procesarGeneracionActo"});'
,p_stop_execution_on_error=>'Y'
);
...
,p_process_name=>'Generar Documentos Masivos'
...
'    pkg_cb_proceso_juridico.prc_rg_dcmnto_msvo_prcso_jrdco ( p_id_plntlla    => :P18_ID_PLNTLLA,',
'                                                             p_json_procesos => :P18_JSON , ',
'                                                             p_id_usrio      => :F_ID_USRIO,',
'                                                             p_id_lte_imprsion => v_id_lte_gnrado);',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when=>'procesarGeneracionActo'
