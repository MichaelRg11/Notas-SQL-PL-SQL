...
--   Date and Time:   15:42 Tuesday November 30, 2021
...
,p_last_upd_yyyymmddhh24miss=>'20211013104754'
);
...
'     apex_json.write(''o_file_name'', ''Lote_''||v_lte||''_''||to_char(sysdate,''yyyymmddhhmiss'')||''.xlsx'');',
'     apex_json.close_object();',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
