...
--   Date and Time:   15:43 Tuesday November 30, 2021
...
,p_last_updated_by=>'RVILLALOBOS1'
,p_last_upd_yyyymmddhh24miss=>'20211013104819'
);
...
,p_button_condition=>'P34_ID_EMBRGOS_SMU_LTE'
...
,p_button_position=>'BELOW_BOX'
,p_button_redirect_url=>'f?p=&APP_ID.:132:&SESSION.::&DEBUG.:RP,132:P132_ID_PRCSO_SMU_LOTE,P132_ID_CRGA:&P34_ID_EMBRGOS_SMU_LTE.,&P34_ID_CRGA.'
...
'    v_file_name    varchar2(100)  := ''Lote_Medida_Cautelar_''||v_lte||''_''||to_char(sysdate,''yyyymmddhhmiss'')||''.xlsx'';',
'begin',
...
'                        where   a.id_embrgos_smu_lte = v_lte',
